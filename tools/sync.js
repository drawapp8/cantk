...
var files = [
				...
				{"path": "../cantk-third/js/", "name": "chart.js"},
				{"path": "../cantk-third/js/", "name": "cantk_chart.js"},
...
for(var i = 0; i < files.length; i++) {
	var iter = files[i];
	var src = "/opt/tangide/dev/tangide/jsbuilder/" + iter.path + iter.name;
