 ...
 * Wether enable camera follow.
 * NOTICE：Virtual width need to be setted greater than scene width, or virtual height greater than scene height, otherwise camera follow will not work.
 */

/**
 * @method setGravityScale
 * Sets the rigidbody's gravity coefficient, and actively edits an individual rigidbody's gravity. 
 * @param {Point} gravityScale Gravity coefficient.
 * @return {UIElement} Returns element.
 *
 *
 * Removes gravity effects.
 *
 *     @example small frame
 *     this.setGravityScale({x:0, y:0});
 *
 * Reverse of Y axis gravity: 
 *
 *     @example small frame
 *     this.setGravityScale({x:0, y:-1});
 
 * Half of Y axis gravity:
 *
 *     @example small frame
 ...
 * Sets the rigidbody's elasticity coefficient.
 * @param {Number} restitution The rigidbody's elasticity coefficient.
 * @return {UIElement} Returns element.
 *
 */
 ...
 * Gets the rigidbody's elasticity coefficient.
 * @return {Number} Returns the rigidbody's elasticity coefficient.
 *
 */

/**
 * @method setFriction
 * Sets the rigidbody's friction coefficient.
 * @param {Number} friction The rigidbody's friction coefficient.
 * @return {UIElement} Returns element.
 *
 */
...
/**
 * @method getFriction
 * Gets the rigidbody's friction coefficient.
 * @return {Number} Returns the rigidbody's friction coefficient.
 *
 */
