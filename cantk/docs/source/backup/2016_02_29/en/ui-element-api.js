 ...
 * @param {String} type event type.Now supports:"updatetransform","pointerdown","pointermove","pointerup","click","removed","changing","change","moved","begincontact","endcontact","becomezero","becomefull","timer".
 ...
 *         alert(button.name + ":" + JSON.stringify(event.point));
 *     }
 *     this.find("button").addEventListener("click", onButtonClicked);
 */
