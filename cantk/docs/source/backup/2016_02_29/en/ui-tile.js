 ...
 *
 * 2. To start the physics engine: Create an image layer in tiled, then add some custom properties to the layer. When physics = true, the physics engine will be enabled. Friction indicates the friction index; restitution indicates the elasticity index.
 *
