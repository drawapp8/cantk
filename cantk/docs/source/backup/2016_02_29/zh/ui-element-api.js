 ...
 *
 * 注册事件的回调函数。
 * @param {String} type 事件的类型。目前支持"updatetransform","pointerdown","pointermove","pointerup","click","removed","changing","change","moved","begincontact","endcontact","becomezero","becomefull","timer"。
