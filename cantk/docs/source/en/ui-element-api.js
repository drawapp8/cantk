 ...
 * The animations edited by Hola Studio animation editor. You can get animation configuration by name.
 *
 *     @example small frame
 ...
 * @param {Point} point relative to top left corner of current element
 * @param {Boolean} recursive Whether to search recursively.
 * @param {Function} checkFunc Callback function used to check whether element is required.
 * @return {UIElement} Returns child element if found, otherwise return element self.
 *
 *     @example small frame
 ...
 * Gets the input type.
 * @return {String} "pointer":pointer deviece， "touch":touch screen， "mouse":mouse。
 */
 ...
 * @return {UIWindow} The window/scene the element is located in.
 */

/**
 * @method getTopWindow
 * Gets the top window.(Normal window/Dialog/Scene).
 * @return {UIWindow} the top window.
 */
 ...
 *
 * You can get the optional image by index:
 *
 *     @example small frame
 ...
 * @return {Boolean} Whether enable the playing of sound effects and background music.
 */

/**
 * @method getSoundMusicEnable
 * Gets the enabled/disabled state of background music.
 * @return {Boolean} Whether enable the playing of background music
 */

/**
 * @method getSoundEffectEnable
 * Gets the enabled/disabled state of sound effects.
 * @return {Boolean} Whether enable the playing of sound effects.
 */
 ...
 * Convert point in element to point in UIWindow.
 * @param {Point} point point in element.
 * @return {Point} point in UIWindow. 
 *
 */

/**
 * @method globalToLocal 
 * Convert point in UIWindow to point in element.
 * @param {Point} point point in UIWindow.
 * @return {Point} point point in element.
 *
 */
...
/**
 * @event onClick
 * onClick event. The event will stop delivery when event handler returns true(Parent element will not handle it).
 ...
 * This needs to be added during the custom module in order to be listed among IDE events.
 *
 * The event will stop delivery when event handler returns true.
 *
 ...
 * @method beforePaint
 *
 * The method will be called before element painted(You cann't call it directly). You can override it for achieving special effects.
 * @param {Object} canvas2dCtx HTMLCanvasContext2D 
 *
 * Refrence：[https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D](https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D)
 *
 *     @example small frame
 ...
 * @method afterPaint
 *
 * The method will be called after element paintd(You cann't call it directly)，You can override it for achieving special effects.
 * @param {Object} canvas2dCtx HTMLCanvasContext2D 
 *
 * Refrence：[https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D](https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D)
 *
 ...
 * @method drawBgImage
 *
 * The method is used to paint background image of element(You can't call it directly). You can override it for achieving some special effects.
 * @param {Object} canvas2dCtx HTMLCanvasContext2D 
 *
 * Refrence：[https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D](https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D)
 * You can put the code below in onBeforeOpen, it achieves dynamic background effect.
 *  
 *     @example small frame
 *      var win = this.win;
 *      win.bgOffsetX = 0;
 ...
 * @param {String} type event type.Now supports:"updatetransform","pointerdown","pointermove","pointerup","click","removed","changing","change","moved","begincontact","endcontact","becomezero","becomefull","timer","open","scrolldone","scrolling".
 * @param {Function} callback callback function。The prototype is callback(event). The "this" in callback is the specified element, the members of event are as same as the parameter of corresponding event.
 * Notice: The event will stop delivery when event callback handler returns true.
 *
 *     @example small frame
 ...
 * @param {String} type event type. Refrence to addEventListener.
